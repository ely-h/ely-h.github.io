      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative border-l-2 border-pastelBlue/30 pl-8 pb-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-pastelBlue/10 hover:border-pastelYellow transition-colors group">
            ...
            <h3 className="text-2xl font-bold text-textPrimary mb-1 group-hover:text-pastelBlue transition-colors">
              Ingénieur Systèmes Embarqués
            </h3>
            <p className="text-textSecondary font-medium mb-4">Marine Nationale (ALFOST), Base Navale de Brest</p>
            
            <div className="mb-4">
              <h4 className="font-semibold text-textPrimary mb-2 text-sm uppercase tracking-wider">Missions :</h4>
              <ul className="list-disc list-inside text-textSecondary space-y-1">
                <li>Conception et déploiement d'un réseau d'interphonie</li>
                <li>Configuration de Raspberry Pi et serveur (Asterisk)</li>
                <li>Réalisation UI/UX des interphones</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Python (Kivy)', 'Asterisk', 'Figma', 'Proxmox', 'LXC', 'Raspberry Pi', 'Linux', 'JAMS/JAMI', 'Bash'].map(tech => (
